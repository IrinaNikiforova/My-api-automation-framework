...
export class RequestHandler {
    ...
    let responseJSON: any;
        ...
        await test.step(`GET request ${url}`, async () => {
            ...
            this.statusCodeValidation(actualStatus, statusCode, this.getRequest);
        });
        return responseJSON;
    }
    ...
    async postRequest(statusCode: number) {
        ...
        await test.step(`POST request ${url}`, async () => {
        ...
        this.logger.logResponse(actualStatus, responseJSON);
        this.statusCodeValidation(actualStatus, statusCode, this.postRequest);
        });
    ...
    async putRequest(statusCode: number) {
        ...
        await test.step(`PUT request ${url}`, async () => {
        ...
        this.logger.logResponse(actualStatus, responseJSON);
        this.statusCodeValidation(actualStatus, statusCode, this.putRequest);
        });
      ...
      async deleteRequest(statusCode: number){
        ...
        this.statusCodeValidation(actualStatus, statusCode, this.deleteRequest);
    });
    }
    ...
    private statusCodeValidation(actualStatus: number, expectedStatus: number, callingMethod: Function) {
